  ...
  private initializeProducts() {
    const products: InsertProduct[] = [
      ...
      // },
      {
        ...
        category: 'sweatshirt',
        price: '43.00',
        description: 'A classic navy blue crewneck sweatshirt with a playful graphic. It features the word "HOLA!" in a bright yellow, bold font with a stylish "drip" effect. A hidden smiley face in the exclamation point adds a fun, friendly touch.',
        image: '/generated_images/HOLA-1.png',
        printfulUrl: 'https://printful.com/custom-products/mens-clothing/sweatshirts-hoodies',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      },
      {
        name: '"Graffiti Hola!" Sweatshirt',
        category: 'sweatshirt',
        price: '44.50',
        description: 'Show off your urban style with this navy blue sweatshirt. It features a vibrant, graffiti-style "HOLA!" graphic complete with a dynamic blue-and-orange gradient, drip effects, and a playful smiley face exclamation point.',
        image: '/generated_images/HOLA-2.png',
        printfulUrl: 'https://printful.com/custom-products/mens-clothing/sweatshirts-hoodies',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      },
      {
      ...
      },
      {
        ...
        image: '/generated_images/yellow-sweatshirt.png',
        printfulUrl: 'https://printful.com/custom-products/mens-clothing/sweatshirts-hoodies',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      },
      // {
      ...
      // },
      {
        ...
        image: '/generated_images/tshirt.png',
        printfulUrl: 'https://printful.com/custom-products/mens-clothing/t-shirts',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      },
      // {
